...
The documentation directories have distinct lifecycles: ADRs record durable
decisions, architecture documents describe the current system, contracts define
observable behavior, the handbook defines contributor practices, runbooks define
operational procedures, and plans coordinate bounded work and handoffs.
